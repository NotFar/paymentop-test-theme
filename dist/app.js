...
jQuery(document).on('click', '.theme-form .theme-form-submit', function (e) {
  e.preventDefault();
  var form = jQuery(this).closest('.theme-form');
  var field_required = form.find('.field_required');
  var error = '';
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpaymentop_test_theme"] = self["webpackChunkpaymentop_test_theme"] || [];
